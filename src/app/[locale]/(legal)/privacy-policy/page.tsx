...
export async function generateMetadata({
  ...
  return {
    ...
    title: "Privacy Policy | tennis-voice-chat",
    description: "Privacy Policy for tennis-voice-chat - Learn how we handle your data. We prioritize your privacy and data security.",
    ...
    <main className="flex flex-col min-h-screen py-12">
      ...
      <Container className="space-y-12 max-w-4xl mx-auto">
        ...
        <section className="space-y-4">
          <TypographyP>
            tennis-voice-chat ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy applies to information we collect when you use our website at
            {" "}
