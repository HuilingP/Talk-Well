...
export async function generateMetadata({
  ...
  return {
    ...
    title: "Terms of Use | tennis-voice-chat",
    description: "Terms of Use for tennis-voice-chat. Learn about the rules and regulations governing the use of our services.",
    ...
    <main className="flex flex-col min-h-screen py-12">
      ...
      <Container className="space-y-12 max-w-4xl mx-auto">
        ...
        <section className="space-y-4">
          <TypographyP>
            Welcome to tennis-voice-chat ("we," "our," or "us"). By accessing or using our website at
            {" "}
        ...
        <section className="space-y-4">
          ...
          <TypographyP>
            tennis-voice-chat provides a boilerplate for Next.js projects. All tools are provided on an "as is" and "as available" basis.
          </TypographyP>
