            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <Button asChild size="lg" className="rounded-full">
                  <Link href="https://github.com/HuilingP/tennis-voice-chat" target="_blank">
                    Get Started
            ...
            <div className="flex-1 relative max-w-md">
              ...
              <div className="relative bg-background rounded-xl shadow-xl border overflow-hidden">
                ...
                <div className="bg-black text-green-400 p-4 font-mono text-sm">
                  <p className="mb-1">$ git clone https://github.com/HuilingP/tennis-voice-chat.git</p>
                  <p className="mb-1">$ cd tennis-voice-chat</p>
